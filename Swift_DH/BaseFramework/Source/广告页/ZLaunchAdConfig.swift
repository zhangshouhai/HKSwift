...
@objc public class ZLaunchSkipButtonConfig: NSObject {
    /// frame
    @objc public var frame = CGRect(x: Z_SCREEN_WIDTH - 60,y: 42, width: 40,height: 40)
    /// 背景颜色
    ...
    /// 跳过按钮类型
    @objc public var skipBtnType: ZLaunchSkipButtonType = .timer
    /// 圆形进度颜色
    @objc public var strokeColor = UIColor.red
    /// 圆形进度宽度
    @objc public var lineWidth: CGFloat = 2
    /// 圆角
    @objc public var cornerRadius: CGFloat = 20
    /// 边框颜色

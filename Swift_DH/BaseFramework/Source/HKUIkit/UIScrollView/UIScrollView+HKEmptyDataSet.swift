//
//  UIScrollView+HKEmptyDataSet.swift
//  BaseFramework
//
...
extension UIScrollView {
    ...
    public func title(forEmptyDataSet scrollView: UIScrollView!) -> NSAttributedString! {
        ...
        attStr.addAttribute(NSAttributedString.Key.strokeColor, value: UIColor(red: 51/255.0, green: 51/255.0, blue: 51/255.0, alpha: 1), range: NSMakeRange(0, text.count))
        
        attStr.addAttribute(NSAttributedString.Key.font, value: UIFont.systemFont(ofSize: 17), range: NSMakeRange(0, text.count))

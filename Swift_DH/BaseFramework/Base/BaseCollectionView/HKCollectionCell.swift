...
public class CollectionCell<T: UICollectionViewCell> {
    ...
    //加载 collectionCell
    static func collectionView(_ collectionView: UICollectionView ,indexPath:IndexPath) -> T {
    ...
    static func collectionHeaderView(_ collectionView: UICollectionView ,indexPath:IndexPath) -> T {
    ...
    static func collectionFooterView(_ collectionView: UICollectionView ,indexPath:IndexPath) -> T {
...
public class Collectionheader<T: UICollectionReusableView> {

...
//    self.timeLabel.center = CGPointMake(self.itemWidth * 0.5f, self.itemHeight * 0.5f);
    ...
    self.lineWidth = (self.itemWidth - self.middleInterval)  / self.numberOfItems;
}
...
- (void)updateItems {
    ...
    int leftX = (self.itemWidth - self.middleInterval + self.lineWidth);
